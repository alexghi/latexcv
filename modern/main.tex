...
{
	\mbox{\mystrut \hspace{90pt}\textit{#1}}\\
	#2
}
...
\\During my tenure at Paymo, I undertook the development of a mobile application. This project involved the utilization of technologies such as React Native, GraphQL, and various other tools.\\
\\As a personal endeavor, I recently crafted a mobile radio application, called Radio Aripi Spre Cer using React Native. I am concurrently engaged in several other ongoing projects.\\
\\Furthermore, I have embarked on the role of an educator. I currently teach web development to students at an informal school and lead a class at the University Emanuel of Oradea, specializing in Advanced Concepts in Web Programming. This teaching experience is particularly gratifying and aligns seamlessly with my interests.\\[-2pt]
...
%
\cvevent{2023 - present}{Teacher}{University Emanuel of Oradea}
...
{Conducting lectures, demonstrations, and coding sessions to teach students how to use React effectively.}
{Design practical projects that enable students to apply React concepts in real-world scenarios.}
...
{Develop a comprehensive business plan that outlines the startup's goals.}
