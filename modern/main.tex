...
%----------------------------------------------------------------------------------------
\cvsection{Summary}
\\I hold a Master of Science in Engineering, specializing in Networking and Telecommunications. I have gained hands-on project experience in the private sector.\\
\\At Paymo, I worked on multiple projects, last one being building a mobile application using React Native, GraphQL, and related tools.\\
\\After Paymo was acquired by Profitsolv, I continued working on projects such as iOrion (an app for lawyers), where I built their mobile application using the same stack, and later contributed to other projects using React.\\
\\As a personal project, I created a mobile radio application, Radio Aripi Spre Cer, using React Native and NodeJS \\ - https://apple.co/430v2Nq. \\
\\I also taught a course at Emanuel University of Oradea on Advanced Concepts in Web Programming, which was a rewarding experience and closely aligned with my professional interests.\\[-2pt]
\\In my free time, I enjoy reading, hiking, and taking photos of people, nature, and landscapes.\\[-2pt]
...
%
\cvevent{2022 - present}{Team Lead}{Profitsolv}
{Developed the mobile app iOrion (iOrion6) in ReactNative, an app for lawyers to manage their cases, clients, and appointments}
{Accelerated the development process in another project from the portfolio (MangoShare - a filesharing platform) with a React frontend and Node.js backend, under GCP infrastructure (Google Cloud Platform)}
{Led a team of 4 and made architectural changes to a very old project, which resulted in a stability increase of the app, customer satisfaction, reduced costs, and increased revenue}
...
{Developed a comprehensive business plan that outlines the startup's goals, had an MVP ready.}
{Probably the most valuable outcome of this was building a network of contacts, attending international events, and leveraging connections to gain insights, partnerships, potential business opportunities. Pitched the idea to investors}
