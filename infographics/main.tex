...
\begin{tabular*}{1\textwidth}{ c c c}
	\parbox[c]{0.4\linewidth}{
		\colorbox{thirdcol}{\HUGE{\textcolor{titletext}{\textbf{\uppercase{Alex Ghiurau}}} }}\\
		\Large{\textcolor{thirdcol}{\textsc{Software Eng.}}}\\
	}&
	\parbox{0.25\textwidth}{
	\icontext{MapMarker}{12}{Oradea, Romania}\\
	\icontext{MobilePhone}{12}{+40 748 575 751}\\
	\icontext{Send}{12}{alex.ghiurau@gmail.com}\\
	}&
	\parbox{0.3\textwidth}{
	\icontext{Github}{12}{github.com/alexghi}\\
	\icontext{Twitter}{12}{@AlexGhiurau}\\
	}
\end{tabular*}
...
%----------------------------------------------------------------------------------------
	...
	\mbox{
		...
		\textcolor{textcol}{I am a networking \& telecommunications graduate with working experience in the private sector.}
		}
		\hspace{10pt}
		\parbox[c][3cm][c]{0.32\textwidth}{
			\begin{center}
			\factbubble{\huge{\textcolor{sectcol}{\textbf{B.Sc.Eng.}}}\\\small{\textcolor{sectcol}{\textbf{Networking}}}}{1}{maincol}{sectcol}{thirdcol}\\
			\textcolor{textcol}{as latest degree from}\\
			\textcolor{textcol}{\textbf{Oradea}}
			\end{center}
		}
		\hspace{10pt}
		\parbox[c][3cm][c]{0.29\textwidth}{
...
%----------------------------------------------------------------------------------------
	...
	\mbox{
		...
		\parbox[b][150pt][c]{0.35\textwidth}{
			...
			\icontext{Language}{12}{\colorbox{maincol}{Romanian (native)}}\\
	...
	\mbox{\hspace{-14pt}
		\begin{barchart}{10}{5.5}{sectcol}{textcol}{sectcol}{maincol}{secondcol}{thirdcol}
			...
			\baritem{90}{React}{100}{0}{0}
			\baritem{90}{ReactNative}{90}{0}{0}
			\baritem{90}{GraphQL}{0}{0}{87}
			\baritem{90}{Firebase}{0}{0}{77}
			\baritem{75}{MySQL}{0}{0}{65}
			\baritem{65}{HTML/CSS}{0}{0}{75}
		\end{barchart}
		\hspace{10pt}

		% TEXTBOX
		\parbox[b][100pt][c]{0.3\textwidth}{\textcolor{textcol}{Currently, I develop apps with ReactNative.\\Formerly I worked with ExtJS.}}
	}
	\begin{center}
	\begin{tikzpicture}
		\draw[draw=sectcol,dashed, opacity=0.5] (4,0) -- (-4,0);
	...
	\mbox{
		\parbox[b][2cm][c]{3cm}{
			\textcolor{textcol}{I regularly use React, Git and PhpStorm for my dev projects.}
		}\hspace{12pt}
		\bubbles{6/PhpStorm, 5/Git, 5/Sourcetree, 4/Linux, 3/Office}{\cvsection{Technologies}}
	}
	\end{center}
%---------------------------------------------------------------------------------------
%	ACTIVITIES
%----------------------------------------------------------------------------------------
	...
	\mbox{
		...
		\parbox[b][3cm][c]{3cm}{
			...
			\textcolor{textcol}{of actively biking in}\\
			\textcolor{textcol}{\textbf{Mountains}}
		}

		% TEXT BOX
		\parbox[b][3cm][c]{4cm}{
			\textcolor{textcol}{In my freetime I read books and help others however I can. Via biking \& music I keep my body and mind in balance.}
		}

		% SQUARE BARS
		\squares{20/Tea,20/Music,30/Books,20/Stackoverflow}{1}
	}
\end{minipage}
...
\cvevent{10/2011}{11/2014}{Bachelor Studies}{Uni Oradea}
...
\cvevent{11/2012}{11/2013}{Master Project - PrIMA}{University of Oradea}
...
\cvevent{11/2014}{9/2016}{IT Consultant @We4IT}{We4IT GmbH Oradea}
    {Realize projects in XPages and We4IT Aveedo, monitor project status, conduct reports}
    {maincol}{1}

\cvevent{7/2015}{7/2015}{M.Sc. Graduation}{University of Oradea}
    {Master Thesis: Semi Automated Scoring in Technology Based Assessment}{thirdcol}{0}

\cvevent{5/2016}{5/2016}{Startup Weekend}{Uni Oradea}
    {Performed a two-day project simulation from management perspective}{secondcol}{0}

\cvevent{9/2016}{12/2016}{Software Engineer @UO}{University of Oradea}
    {text a}{maincol}{1}
    
\cvevent{10/2018}{10/2018}{Software Engineer @UO}{University of Oradea}
    {text a}{maincol}{1}    
